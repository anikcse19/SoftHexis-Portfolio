...
const HeroSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center pt-24 overflow-hidden">
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 relative z-20">
        <div className="max-w-3xl">
          ...
          >
            From concept to implementation, we bring your vision to life with beautiful design and flawless functionality.
          </motion.p>
        ...
        <motion.div 
          className="absolute -bottom-16 right-0 left-0 h-16 bg-gradient-to-t from-background to-transparent"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
